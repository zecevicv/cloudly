...
animations[0]
        ...
        // Header Text Content
        .from('.header__content > div > h1', {duration: 1, ease:"back.out(1)", opacity: 0, x: "-75px"})
        .from('.header__content > div > p', {duration: 1, ease:"back.out(1)", opacity: 0, x: "75px"}, "<")
        .from('.header__content > div > div', {duration: 1, ease:"back.out(1)", opacity: 0, y: "75px"}, "<")
        // SVG Icons
        ...
        // SVG Icons
        .to('.header #Layer_2 g[id^="object"]', {duration: 3.5, ease:"power0", y: -20, repeat: -1, yoyo: true}, "+=.25");
...
animations[3]
        .from('.features-2 .card-large__wrapper', {duration: 1, ease:"bounce", opacity: 0, y: -100, stagger: {each:.2, from: "start"}});
...
animations[5]
        .from('.featured-box--2', {duration: .5, opacity: 0});

animations[6]
        .from('.special-needs__box', {duration: 1, opacity: 0, ease: 'bounce', y: "-50%", stagger: .25});
